function data = read_Intan(filename)
...
%
% Modified by Ke. 5/11/2018
% 
% Input: 
%     file: is the name of the file; for instance: 'test_180427_113454.rhd'
%     path: path of the file
% Output:
%     data.adc_channel : information about the analog channel
%     data.dig_channel : information about the digital channel
%     data.analog      : data recorded from analog input
%     data.event       : data recorded from digital input
%     data.freq        : recording frequency
%     data.ts          : timestamps for the data (analog and event should be the same, taken from digital signal)
...
data.adc_channel = board_adc_channels;
data.dig_channel = board_dig_in_channels;
data.analog      = board_adc_data;
data.event       = board_dig_in_data;
data.freq        = frequency_parameters.board_adc_sample_rate;
data.ts          = t_dig;
