...
resp1 = tastetest(neuron2,trial2); % for claculate the taste evoked response; baseline is 0.5 s before the taste
...
resp3 = tasteResponse10(neuron2_2,trial2);  % use 1 s before tone as the baseline for cue and use 0.5 s before lick as baseline
...
save(['summary','_',animalID,'_','date_v2','.mat'],'data1', 'neuron2')
msgbox('Done')
