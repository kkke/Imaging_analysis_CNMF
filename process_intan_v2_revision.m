...
function [data,trial] = process_intan_v2_revision(filename);
...
unit  = spike2eventRasteandPSTH_NP(Frame,Tone,100,-3000,17000);
...
unit7 = spike2eventRasteandPSTH_NP(licks,Tone,100,-3000,17000);
